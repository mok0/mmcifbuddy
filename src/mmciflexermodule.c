...
PyMODINIT_FUNC PyInit__mmciflexer()
{
  ...
  */
  ...
  PyModule_AddIntConstant(module, "tSAVE", tSAVE);
  PyModule_AddIntConstant(module, "tCATEGORY", tCATEGORY);
  PyModule_AddIntConstant(module, "tITEM", tITEM);
  ...
  PyTuple_SetItem(names, (Py_ssize_t)tSAVE, PyUnicode_FromString("tSAVE"));
  PyTuple_SetItem(names, (Py_ssize_t)tCATEGORY, PyUnicode_FromString("tCATEGORY"));
  PyTuple_SetItem(names, (Py_ssize_t)tITEM, PyUnicode_FromString("tITEM"));
